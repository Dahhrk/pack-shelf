    ...
    <section id="app-ui" className="py-20 px-6 max-w-6xl mx-auto">
      ...
      <div className="space-y-16">
        ...
        <div id="specimen-command-palette">
          ...
          <p className="text-xs text-stone-600 mb-4">
            Press <kbd className="px-1 py-0.5 rounded bg-stone-800 border border-stone-700 text-[10px] font-mono">⌘K</kbd> or click to open. Fuzzy search, arrow navigation, escape to close.
          </p>
          <CommandPalette />
        </div>
        ...
        <div className="border-t border-stone-800 pt-16">
          <h3 className="text-lg font-bold text-stone-300 mb-8">
        ...
        <div id="specimen-layout-transition">
          ...
          <p className="text-xs text-stone-600 mb-4">
            Tab indicator animates between tabs using Motion <code className="text-stone-400">layoutId</code>.
          </p>
          <SharedLayoutTransition />
        </div>
        ...
        <div id="specimen-drag-reorder">
          ...
          <p className="text-xs text-stone-600 mb-4">
            Drag tasks to reorder. Uses Motion <code className="text-stone-400">Reorder</code> group with spring layout animations.
          </p>
          <DragReorderList />
        </div>
        ...
        <div id="specimen-scroll-progress">
          ...
          <p className="text-xs text-stone-600 mb-4">
            Progress bar driven by container scroll position via Motion <code className="text-stone-400">useScroll</code>.
          </p>
          <ScrollLinkedSection />
        </div>
      </div>
