  ...
  return (
    <section id="react-bits" className="py-20 px-6 max-w-6xl mx-auto">
      ...
      <p className="text-stone-400 mb-12 max-w-xl">
        ...
        <a href="https://reactbits.dev" className="underline text-stone-300" target="_blank" rel="noopener noreferrer">
          reactbits.dev
      ...
      <div className="space-y-16">
        ...
        <div>
          ...
          <ClickSpark sparkColor="#fb7185" sparkCount={10}>
            <div className="rounded-xl bg-stone-900 border border-stone-800 p-12 text-center cursor-pointer select-none">
              <p className="text-lg font-medium text-stone-300">
                Click anywhere in this area
              </p>
              <p className="text-sm text-stone-500 mt-1">Sparks fly on click</p>
            </div>
          </ClickSpark>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-6 items-center justify-center py-8">
            ...
            <Magnet>
              <button className="px-6 py-3 bg-stone-800 border border-stone-700 rounded-xl font-medium">
                Hover Me
              </button>
            </Magnet>
          </div>
        ...
        <div>
          ...
          <p className="text-xs text-stone-600 mb-4">
            Animated number roll — values are component demo targets, not metrics.
          </p>
          ...
          <div className="max-w-md">
            <AnimatedList
              items={listItems.map((item, i) => (
                <div
                  key={i}
                  className="mb-2 rounded-lg bg-stone-900 border border-stone-800 px-4 py-3 text-sm flex items-center gap-3"
                >
            ...
            {listItems.length < notifications.length && (
              <p className="text-xs text-stone-600 mt-2">Adding items...</p>
            )}
          </div>
        </div>
      </div>
