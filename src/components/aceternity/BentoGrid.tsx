...
export function BentoGridItem({
  ...
  return (
    <div
      className={cn(
        "row-span-1 rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-none p-4 bg-zinc-900 border border-zinc-800 justify-between flex flex-col space-y-4",
        className,
      )}
    >
      {header}
